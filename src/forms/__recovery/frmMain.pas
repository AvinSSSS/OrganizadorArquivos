...
type
  ...
  private
    ...
    /// <summary>Confirma e envia o item indicado para a Lixeira.</summary>
...
begin
  FileName := dmFileOrganizer.FilePath(Index);
  if MessageDlg(Format('Mover o arquivo "%s" para a Lixeira?',
  ...
  try
    ...
    ShowPreview;
    lblStatus.Caption := 'Arquivo movido para a Lixeira.';
  except
    on E: Exception do
